...
function ScriptCtrl(e,o){var t=ace.edit("editor");t.setTheme("ace/theme/monokai"),t.getSession().setMode("ace/mode/sh"),o.commands,t.setValue(o.commands),e.clearWindow=function(){t.setValue("")},e.showWindow=function(){t.setValue("pwd       \nping -c 5 wwww.gooogle.pl\nifconfig")},e.$on("sid",function(e,n){var s=n,c=t.getValue();console.log("sid function"+{cmd:c,sid:s}),o.$broadcast("skrypt",{cmd:c,sid:s})}),e.saveWindow=function(){o.commands=t.getValue(),alert("To save it on server, You need to choose one of the listed serves!")}}angular.module("RDash").controller("ScriptCtrl",["$scope","$rootScope",ScriptCtrl]);
function ServersCtrl(e,o,n){var s="",c=window.location;s=c.host,o.servers,void 0==o.results&&(o.results={}),e.see,e.connected="false",e.connect="true",e.loading="false",e.spinner="false",e.myWebSocket=new WebSocket("ws://"+s+"/api/listmachines"),e.myWebSocket.onmessage=function(n){console.log("onmessage. size: "+n.data);var s=JSON.parse(n.data);e.$apply(function(){o.servers=s})},e.myWebSocket.onopen=function(){e.myWebSocket.send("START"),console.log("onopen - myWebSocket"),e.connected="true",e.connect="false"},e.myWebSocket.onclose=function(){console.log("onclose - myWebSocket"),e.connected="false",e.connect="true"},e.myWebSocket.onerror=function(){console.log("Error!")},e.myResultWebSocket=new WebSocket("ws://"+s+"/api/screens"),e.myResultWebSocket.onmessage=function(n){console.log("My myResultWebSocket size: "+n.data);var s=JSON.parse(n.data);id=s.id.toString(),console.log("ID: "+id),cmd=s.cmd,console.log("cmd: "+cmd),e.$apply(function(){id in o.results?o.results[id].push(cmd):o.results[id]=[cmd]}),console.log(o.results)},e.myResultWebSocket.onopen=function(){e.myResultWebSocket.send("START"),console.log("onopen - myResultWebSocket"),e.connected="true",e.connect="false"},e.myResultWebSocket.onclose=function(){console.log("onclose - myResultWebSocket"),e.connected="false",e.connect="true"},e.myResultWebSocket.onerror=function(){console.log("Error!")},e.addServer=function(){console.log("Zaczynamy dodawac"),e.loading="true",n.get("http://"+s+"/api/addmachine").success(function(){console.log("OK, server will be added soon"),e.loading="false"}).error(function(){console.log("Fail http get")})},e.connectToWS=function(){e.myWebSocket.send("START"),e.myResultWebSocket.send("START")},e.seeServer=function(o){e.see=o},e.sendToServer=function(e){var n=o.servers[e].id;console.log("send server sid: "+n),o.$broadcast("sid",n)},e.$on("skrypt",function(o,n){var s=n.sid,c=n.cmd;console.log("skrypt broadcast sid: "+s+" cmd: "+c),e.myResultWebSocket.send('{"id": "'+s+'", "cmd": "'+c+'"}')}),e.closeServer=function(o){e.servers.splice(o,1)},e.refreshServers=function(){e.spinner="true",n.get("http://"+s+"/api/refreshmachines").success(function(){console.log("OK, list will be refreshed"),e.spinner="false"}).error(function(){console.log("Fail http get")})},e.closeAllServers=function(){e.spinner="true",n.get("http://"+s+"/api/removeall").success(function(){console.log("OK, all servers will be removed soon"),e.spinner="false"}).error(function(){console.log("Fail http get")})}}angular.module("RDash").controller("ServersCtrl",["$scope","$rootScope","$http","$filter",ServersCtrl]);
