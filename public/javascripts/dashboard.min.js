...
function ScriptCtrl(e,o){var t=ace.edit("editor");t.setTheme("ace/theme/monokai"),t.getSession().setMode("ace/mode/javascript"),e.clearWindow=function(){t.setValue("")},e.showWindow=function(){t.setValue("pwd")},e.$on("sid",function(e,n){var s=n,c=t.getValue();console.log("sid function"+{cmd:c,sid:s}),o.$broadcast("skrypt",{cmd:c,sid:s})}),e.saveWindow=function(){e.tekst=t.getValue(),alert("You need to choose one of the listed serves!")}}angular.module("RDash").controller("ScriptCtrl",["$scope","$rootScope",ScriptCtrl]);
function ServersCtrl(e,o,n){var c="",s=window.location;c=s.host,o.servers,void 0==o.results&&(o.results={}),e.see,e.connected="false",e.connect="true",e.loading="false",e.myWebSocket=new WebSocket("ws://"+c+"/api/listmachines"),e.myWebSocket.onmessage=function(n){console.log("onmessage. size: "+n.data);var c=JSON.parse(n.data);e.$apply(function(){o.servers=c})},e.myWebSocket.onopen=function(){e.myWebSocket.send("START"),console.log("onopen - myWebSocket"),e.connected="true",e.connect="false"},e.myWebSocket.onclose=function(){console.log("onclose - myWebSocket"),e.connected="false",e.connect="true"},e.myWebSocket.onerror=function(){console.log("Error!")},e.myResultWebSocket=new WebSocket("ws://"+c+"/api/screens"),e.myResultWebSocket.onmessage=function(n){console.log("My myResultWebSocket size: "+n.data);var c=JSON.parse(n.data);id=c.id.toString(),console.log("ID: "+id),cmd=c.cmd,cmd=c.cmd,console.log("cmd: "+cmd),e.$apply(function(){id in o.results?o.results[id]+=cmd:o.results[id]=cmd}),console.log(o.results)},e.myResultWebSocket.onopen=function(){e.myResultWebSocket.send("START"),console.log("onopen - myResultWebSocket"),e.connected="true",e.connect="false"},e.myResultWebSocket.onclose=function(){console.log("onclose - myResultWebSocket"),e.connected="false",e.connect="true"},e.myResultWebSocket.onerror=function(){console.log("Error!")},e.addServer=function(){n.get("http://"+c+"/api/addmachine").success(function(){console.log("OK, wyslano zadanie dodania maszyny")}).error(function(){console.log("Fail http get")})},e.connectToWS=function(){e.myWebSocket.send("START"),e.myResultWebSocket.send("START")},e.seeServer=function(o){e.see=o},e.sendToServer=function(e){var n=o.servers[e].id;console.log("send server sid: "+n),o.$broadcast("sid",n)},e.$on("skrypt",function(o,n){var c=n.sid,s=n.cmd;console.log("skrypt broadcast sid: "+c+" cmd: "+s),e.myResultWebSocket.send('{ \n            "id": "'+c+'", \n            "cmd": "'+s+'"\n        }')}),e.closeServer=function(o){e.servers.splice(o,1)},e.closeAllServers=function(){n.get("http://"+c+"/api/removeall").success(function(){console.log("OK, all servers will be removed soon")}).error(function(){console.log("Fail http get")})}}angular.module("RDash").controller("ServersCtrl",["$scope","$rootScope","$http","$filter",ServersCtrl]);
